 ...
 *
 * UnsuccessfulTestStepException.groovy is part of resTest.
 *
...
class UnsuccessfulTestStepException extends Exception {

    public UnsuccessfulTestStepException() {
        super()
    }

    public UnsuccessfulTestStepException(String msg) {
        super(msg)
    }
